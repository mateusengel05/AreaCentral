                    ...
                    <table class="table card-table table-vcenter text-nowrap">
                      ...
                      ?>
                          ...
                          <tr>
                              ...
                              <td><?php echo $row['data_u_venda'] ?></td>
                              <td><?php echo $row['total_vendas'] ?></td>
                              <td><?php echo" <a href='manipulacao/exclusao/del_produto.php?id=" . $row['id']. "'>Remover</a>" ?></td>   
                              <td><?php echo " <a href='form-produto-edit.php?id=" . $row['id']. "'>Alterar</a>" ?></td>
                          </tr>
